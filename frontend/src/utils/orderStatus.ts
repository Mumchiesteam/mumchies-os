...
export type OperationalStatus = 'Call Pending' | 'Callback Required' | 'On Hold' | 'Address Verification Pending' | 'Ready for Booking' | 'Booked' | 'Shipped' | 'NDR' | 'Delivered' | 'Cancelled' | 'Needs Review' | 'Customer Requested Cancellation'
